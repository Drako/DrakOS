...
#ifndef DRAKOS_KERNEL_MULTIBOOT_H
#define DRAKOS_KERNEL_MULTIBOOT_H

// the following stuff is copied from the multiboot.h example from the multiboot specification
...
#endif // DRAKOS_KERNEL_MULTIBOOT_H
